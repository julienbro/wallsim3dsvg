...
export class DimensionTool {
    ...
    createDimensionUI() {
        ...
        this.dimensionUI.className = 'dimension-ui-panel';
        this.dimensionUI.style.cssText = `
            position: fixed;
            top: 40%;
            left: 10%;
            background: white;
        ...
        this.dimensionUI.innerHTML = `
            <h4 style="margin: 0 0 10px 0; font-size: 14px;">Options de cotation</h4>
            <div style="margin-bottom: 8px;">
                <label style="font-size: 12px;">Type:</label>
                <select id="dimension-type" style="width: 100%; padding: 3px;">
            ...
            <div style="margin-bottom: 8px;">
                ...
                <input type="number" id="dimension-offset" value="${this.dimensionOffset}" 
                       min="1" max="100" step="1" style="width: 100%; padding: 3px;">
            </div>
            <div style="margin-bottom: 8px;">
                <label style="font-size: 12px;">Taille police:</label>
                <input type="number" id="dimension-font-size" value="${this.textSize}" 
                       min="0.5" max="20" step="0.5" style="width: 100%; padding: 3px;">
            </div>
            <div style="margin-bottom: 8px;">
                <label style="font-size: 12px;">Taille flèches:</label>
                <input type="number" id="dimension-arrow-size" value="${this.arrowSize}" 
                       min="0.5" max="10" step="0.5" style="width: 100%; padding: 3px;">
            </div>
            <div style="margin-bottom: 8px;">
                <label style="font-size: 12px;">Couleur:</label>
                <input type="color" id="dimension-color" value="#0000ff" 
                       style="width: 100%; padding: 3px; height: 25px;">
            </div>
            <div style="margin-bottom: 8px; background: #f0f0f0; padding: 5px; border-radius: 3px;">
                <label style="font-size: 11px; color: #666;">
                    <span id="current-scale-display" style="cursor:pointer;text-decoration:underline dotted #888;" title="Changer l'échelle de cotation">Échelle actuelle: 1:1</span>
                </label>
            </div>
            <div style="margin-bottom: 8px;">
                <button id="dimension-properties-btn" style="width:100%;padding:6px 0;background:#0078d4;color:#fff;border:none;border-radius:4px;cursor:pointer;font-size:13px;">
                    <i class="fas fa-cog"></i> Style global de cotation
                </button>
            </div>
            <div id="dimension-properties-panel" style="display:none; margin-bottom:8px; background:#f9f9f9; border:1px solid #ccc; border-radius:5px; padding:10px;">
                <div style="margin-bottom:8px;">
                    <label style="font-size:12px;">Taille texte :</label>
                    <input type="number" id="dimension-font-size" value="${this.textSize}" min="1" max="20" step="0.5" style="width:100%;padding:3px;">
                </div>
                <div style="margin-bottom:8px;">
                    <label style="font-size:12px;">Taille flèche :</label>
                    <input type="number" id="dimension-arrow-size" value="${this.arrowSize}" min="1" max="20" step="0.5" style="width:100%;padding:3px;">
                </div>
                <div style="margin-bottom:8px;">
                    <label style="font-size:12px;">Style texte :</label>
                    <select id="dimension-font-style" style="width:100%;padding:3px;">
                ...
                <div style="margin-bottom:8px;">
                    <label style="font-size:12px;">Couleur :</label>
                    <input type="color" id="dimension-color" value="#0000ff" style="width:100%;padding:3px;height:25px;">
                </div>
                <div style="margin-bottom:8px;">
                    <label style="font-size:12px;">Calque :</label>
                    <select id="dimension-layer-select" style="width:100%;padding:3px;"></select>
                </div>
                <div style="text-align:right;">
                    <button id="dimension-properties-apply" style="background:#0078d4;color:#fff;border:none;padding:6px 12px;border-radius:4px;cursor:pointer;">Appliquer</button>
                    <button id="dimension-properties-cancel" style="background:#ccc;color:#333;border:none;padding:6px 12px;border-radius:4px;cursor:pointer;margin-left:6px;">Annuler</button>
                </div>
            </div>
        `;
        ...
        propBtn.addEventListener('click', () => {
            ...
            const layerSelect = this.dimensionUI.querySelector('#dimension-layer-select');
        ...
        this.dimensionUI.querySelector('#dimension-properties-apply').addEventListener('click', () => {
            ...
            const propPanel = this.dimensionUI.querySelector('#dimension-properties-panel');
            const fontSize = parseFloat(propPanel.querySelector('#dimension-font-size').value) || this.textSize;
            const arrowSize = parseFloat(propPanel.querySelector('#dimension-arrow-size').value) || this.arrowSize;
            const fontStyle = propPanel.querySelector('#dimension-font-style').value || 'Arial';
            const color = propPanel.querySelector('#dimension-color').value || '#0000ff';
            const layerIdx = parseInt(propPanel.querySelector('#dimension-layer-select').value);
